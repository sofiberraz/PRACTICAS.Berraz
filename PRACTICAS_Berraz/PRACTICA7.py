...
#ejercicio 1:Dadas las siguientes clases responder:
...
#ejercicio 4: Vamos a salir de paseo (¡si la pandemia nos deja!). Para esto podemos utilizar como vehículos motos o autos, y de estos dos medios de transporte sabemos que:
